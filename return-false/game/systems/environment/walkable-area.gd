#####
# environment/walkable-area.gd
# walkable stage, with floor tilemap and input handling for clicks

extends Node2D

export(int) var TILE_ATTRACT     # used by npcs
export(int) var TILE_TRANSITION  # stairs, doors, etc
export(int) var TILE_DEFAULT     # basic walkable
export(int) var TILE_BLOCKED     # basic unwalkable

export(Vector2) var map_size     # used for tile-fill operations; obsolete?
